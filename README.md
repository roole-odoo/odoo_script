...
14. Create a terminal command `odoo-localDB` to run Odoo easily
15. Create 2 desktop shortcut to openning Odoo webpage (user view, manager view)

## Extra install

1. Install rtlcss (right-to-left option for Arabic and Hebrew languages)
2. install mailcatcher
3. Check odoo deps : (./setup/debinstall.sh)
